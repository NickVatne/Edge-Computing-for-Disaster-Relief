...
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w midband_1%_loss_1%_5%_10%_10%.pcap -c 7500
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w midband_5%_loss_2%_10%_15%_15%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w midband_10%_loss_4%_15%_15%_15%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w cnr_network_1%loss_1%_5%_10%_10%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w cnr_network_2%loss_2%_10%_15%_15%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w cnr_network_10%loss_4%_15%_15%_15%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w NATO_Narrowband_waveform_1%loss_1%_5%_10%_10%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w NATO_Narrowband_waveform_5%loss_2%_10%_15%_15%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w NATO_Narrowband_waveform_10%loss_4%_15%_15%_15%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w tactical_broadband_1%loss_1%_5%_10%_10%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w tactical_broadband_5%loss_2%_10%_15%_15%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
...
echo 'Finished adding gemodel'
echo 'Writing'
sudo tcpdump -i wlan0 -s 8883 port not 22 -w tactical_broadband_10%loss_4%_15%_15%_15%.pcap -c 7500
echo 'Finished Writing'
echo 'Removing Loss'
sudo tc qdisc del dev wlan0 root netem
echo 'Completed'
