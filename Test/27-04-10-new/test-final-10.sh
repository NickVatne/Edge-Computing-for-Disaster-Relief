...
sudo tc qdisc add dev eth0 root netem loss gemodel 10% 
...
#echo 'Configuring static 20ms'
#sudo tc qdisc add dev wlan0 root netem delay 20ms
...
sudo tcpdump tcp -i eth0 -s 1500 port not 22 -w 9NAa    O-1gemodel.pcap -c 10000
